...
public class OlderPosts extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener  {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int position, long arg) {
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapter, View view, int position, long arg) {
                        ...
                        Intent appInfo = new Intent(OlderPosts.this, OlderCurrent.class);
