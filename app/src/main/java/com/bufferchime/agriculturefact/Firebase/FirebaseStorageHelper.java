...
public class FirebaseStorageHelper {
    ...
    private void init(){
        ...
        rootRef = firebaseStorage.getReferenceFromUrl("gs://steel-trade-app.appspot.com");
    }
    ...
    public void saveProfileImageToCloud(String userId, Uri selectedImageUri, final ImageView imageView) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                String newuri=taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
                Uri downloadUrl = Uri.parse(newuri);
