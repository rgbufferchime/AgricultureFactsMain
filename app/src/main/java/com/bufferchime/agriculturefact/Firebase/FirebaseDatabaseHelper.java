...
import com.bufferchime.agriculturefact.Adapters.RecyclerViewAdapter;
import com.bufferchime.agriculturefact.helper.Helper;
import com.bufferchime.agriculturefact.UserProfile;
...
public class FirebaseDatabaseHelper {
    ...
    private List<UserProfile> adapterSourceData(DataSnapshot dataSnapshot, String uId){
        ...
        if(dataSnapshot.getKey().equals(uId)){
            ...
            allUserData.add(new UserProfile(Helper.CITY, userInformation.getCity()));
        }
        return allUserData;
    }
}
