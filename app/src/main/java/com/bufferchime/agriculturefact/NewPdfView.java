...
public class NewPdfView extends AppCompatActivity implements DownloadFile.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_pdf_view);
    ...
    public static void open(Context context) {
        Intent i = new Intent(context, NewPdfView.class);
